...
export const AuthFirebaseErrors = {
    ...
    "auth/invalid-email": "	l valor que se proporcionó para la propiedad del usuario email no es válido. Debe ser una dirección de correo electrónico de string.",
    ...
    "auth/wrong-password": "Email o contraseña incorrectas."
} as MessagesIndex;
